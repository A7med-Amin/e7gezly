      ...
      <div className={classes.editmatchcard}>
        <form className={classes.form} onSubmit={Validate}>
          ...
          <div className={classes.control}>
            <label htmlFor="Hteam">
              <span className={classes.vip}>Home</span> Team
            </label>
          ...
          <div className={classes.control}>
            <label htmlFor="Ateam">
              <span className={classes.vip}>Away</span> Team
            </label>
          ...
          <div className={classes.control}>
            ...
            <select name="teams" ref={stadiumRef} style={{ padding: "10px" }}>
              <option className={classes.optionstyle} selected disabled hidden>
                {props.Stadium}
              </option>
              {empdata &&
          ...
          <div className={classes.control}>
            <label htmlFor="Mdate">
              <span className={classes.vip}>Match</span> Date
            </label>
            <input
              type="date"
              required
          ...
          <div className={classes.control}>
            <label htmlFor="Mtime">
              <span className={classes.vip}>Match</span> Time
            </label>
            <input
              type="time"
              required
          ...
          <div className={classes.control}>
            <label htmlFor="MainRef">
              <span className={classes.vip}>Main</span> Refree
            </label>
            <select
              name="teams"
              ref={mainRefreeRef}
          ...
          <div className={classes.control}>
            <label htmlFor="LineManOne">
              Lineman<span className={classes.vip}> 1</span>
            </label>
            <select
              name="teams"
              ref={lineManOneRef}
          ...
          <div className={classes.control}>
            <label htmlFor="LineManTwo">
              Lineman<span className={classes.vip}> 2</span>
            </label>
            <select
              name="teams"
              ref={lineManTwoRef}
