...
const UserInfo = (props) => {
  ...
  const submitHandler = (event) => {
    ...
    if (
      ...
      ConpasswordRef.current.value.length !== 0
    ) {
      Passo = "true";
      console.log(Passo);
    } else {
    ...
    if (loadedMeetups.password !== oldPassword && Passo === "true") {
      ...
      setModalError("You entered the wrong password");
      ...
      setModalVisible(true);
      setModalError("Unmatched Passwords");
    } else if (Passo === "true") {
      const meetupData = {
        password: Password,
        ...
        <form className="form" onSubmit={submitHandler}>
          <div className="control">
            <label htmlFor="username">
              <span className="vip">User</span>Name
            </label>
            <input
              ...
              ref={usernameRef}
              disabled
              value={loadedMeetups.username}
            />
          </div>
          <div className="control">
            <label htmlFor="opass">
              <span className="vip">Old</span> Password
            </label>
            <input
              className="userInputField"
              type="password"
              placeholder="password"
              required={Passo === "true" ? true : false}
              id="opass"
              ref={oldpasswordRef}
            />
          </div>
          <div className="control">
            <label htmlFor="pass">
              <span className="vip">Pass</span>word
            </label>
            <input
              className="userInputField"
              type="password"
          ...
          <div className="control">
            <label htmlFor="cpass">
              <span className="vip">Confirm</span> Password
            </label>
            <input
              className="userInputField"
              type="password"
          ...
          <div className="control">
            <label htmlFor="first_name">
              <span className="vip">First</span> Name
            </label>
            <input
              className="userInputField"
              type="text"
              ...
              id="first_name"
              ref={fisrtNameRef}
              defaultValue={loadedMeetups.first_name}
            />
          </div>
          <div className="control">
            <label htmlFor="last_name">
              <span className="vip">Last</span> Name
            </label>
            <input
              className="userInputField"
              type="text"
              ...
              id="last_name"
              ref={lastNameRef}
              defaultValue={loadedMeetups.last_name}
            />
          </div>
          <div className="control">
            ...
            <input
              ...
              ref={emailRef}
              disabled
              value={loadedMeetups.email}
            />
          </div>
          <div className="control">
            <label htmlFor="birth">
              <span className="vip">Birth</span>date
            </label>
            <input
              className="userInputField"
              type="date"
              ...
              id="birth"
              ref={birthRef}
              defaultValue={loadedMeetups.birthdate}
            />
          </div>

          <div className="type">
            <label className="roleLabel" htmlFor="">
              Gender
            </label>
            <div className="femaleMaleContainer">
              <input
                ...
                name="gender"
                ref={FgenderRef}
                checked={MaleFemale === "F" ? true : false}
                onClick={() => setMaleFemale("F")}
            ...
            <div className="femaleMaleContainer">
              <input
                ...
                name="gender"
                ref={MgenderRef}
                checked={MaleFemale === "M" ? true : false}
                onClick={() => setMaleFemale("M")}
                className="inputGender"
              />
          ...
          <div className="nationalityOptions">
            <label className="roleLabel" htmlFor="nationality">
              City
            </label>
            <select
            ...
            >
              <option
                ...
                value={loadedMeetups.nationality}
                selected
                disabled
                hidden
              >
                {loadedMeetups.nationality}
              </option>
              {egyptGovernorates.map((nationality) => (
                <option value={nationality} className="select_options">
                  {nationality}
                </option>
              ))}
            </select>
          ...
          <div className="control">
            <label htmlFor="last_name">
              <span className="vip">Address</span>
            </label>
            <input
              className="userInputField"
              type="text"
              ...
              id="adress"
              ref={address}
              defaultValue={loadedMeetups.address}
            />
          </div>
